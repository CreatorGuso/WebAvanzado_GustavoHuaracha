...
este archivo tiene un arreglo de películas en forma de objetos, copie el arreglo 
a un archivo propio de JS, recorra el arreglo y retorne en una función solo las 
películas en idioma inglés (“en”).
*/

//Arreglo al final la funcionabilidad.
...
let idiomaBusqueda=prompt("Escriba entre estos lenguajes : 'en','ru','es' ")


if (idiomaBusqueda=="en"||idiomaBusqueda=="ru"||idiomaBusqueda=="es") {
    IdiomaPeliculas(idiomaBusqueda);
}else{
    console.log("Seleccione uno de los idiomas")
}


function IdiomaPeliculas(idiomaBusqueda) {
    for (let X = 0;  X < peliculas.length; X++) {
        if (peliculas[X].original_language==idiomaBusqueda) {
            console.log(peliculas[X].original_title)
        }
    }
}
